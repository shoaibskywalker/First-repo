...
class About : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        elaChat.setSpan(ForegroundColorSpan(resources.getColor(R.color.normalColor)), 0, elaChat.length, 0)
        elaChat.setSpan(RelativeSizeSpan(1f), 0, elaChat.length, 0)
        aboutText.append(elaChat)

        val description = SpannableStringBuilder("  ELA Chat is a secure and user-friendly messaging application designed to facilitate seamless communication between users. With ELA Chat, you can connect with friends, family, and colleagues in real-time, regardless of their location.\n\n")
        ...
        keyFeatures.setSpan(StyleSpan(android.graphics.Typeface.BOLD), 0, keyFeatures.length, 0)
        keyFeatures.setSpan(ForegroundColorSpan(resources.getColor(R.color.normalColor)), 0, keyFeatures.length, 0)
        ...
        endToEndEncryption.setSpan(StyleSpan(android.graphics.Typeface.BOLD_ITALIC), 0, endToEndEncryption.length, 0)
        endToEndEncryption.setSpan(RelativeSizeSpan(0.8f), 0, endToEndEncryption.length, 0)
        aboutText.append(endToEndEncryption)

        val endToEndEncryptionDetail= SpannableStringBuilder("  Your privacy and security are our top priorities. ELA Chat uses end-to-end encryption to ensure that your messages, calls, and shared media remain private and secure.\n" +
                "\n")
        ...
        multiPlatformSupport.setSpan(StyleSpan(android.graphics.Typeface.BOLD_ITALIC), 0, multiPlatformSupport.length, 0)
        aboutText.append(multiPlatformSupport)

        val multiPlatformSupportDetail = SpannableStringBuilder("  Whether you're using an Android device, iOS device, or web browser, ELA Chat provides a consistent and reliable messaging experience across all platforms.\n\n")
        ...
        RichMessaging.setSpan(StyleSpan(android.graphics.Typeface.BOLD_ITALIC), 0, RichMessaging.length, 0)
        ...
        groupChats.setSpan(StyleSpan(android.graphics.Typeface.BOLD_ITALIC), 0, groupChats.length, 0)
        ...
        voiceAndVideoCall.setSpan(StyleSpan(android.graphics.Typeface.BOLD_ITALIC), 0, voiceAndVideoCall.length, 0)
        ...
        customize.setSpan(StyleSpan(android.graphics.Typeface.BOLD_ITALIC), 0, customize.length, 0)
        ...
        messageRecall.setSpan(StyleSpan(android.graphics.Typeface.BOLD_ITALIC), 0, messageRecall.length, 0)
        aboutText.append(messageRecall)

        val messageRecallDetail = SpannableStringBuilder("  Accidentally sent the wrong message? No problem! ELA Chat allows you to recall sent messages within a specified time window.\n\n")
        ...
        userProfile.setSpan(StyleSpan(android.graphics.Typeface.BOLD_ITALIC), 0, userProfile.length, 0)
        ...
        val lastDescription = SpannableStringBuilder("  ELA Chat is committed to providing a secure, reliable, and feature-rich messaging experience for all users. Download ELA Chat now and start connecting with your loved ones today!\n\n")
